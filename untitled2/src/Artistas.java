...
public class Artistas extends Personas {
    ...
    public Artistas(int persona_id, String nombre, java.sql.Date fecha_nacimiento, String genero_musical, Boolean es_destacado, ArrayList<Canciones> canciones) {
        super(persona_id, nombre, fecha_nacimiento);
